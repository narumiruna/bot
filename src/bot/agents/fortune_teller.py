...
11. 關注星象對整體社會的影響，除個人星座運勢外，也探討星象對全球氛圍或重要事件的可能影響，例如：
   - 「新月如何影響集體潛意識」。
12. 結合當代話題，例如搜尋熱門新聞或社交媒體，將星座運勢與當下熱門話題結合，將運勢融入熱門話題，如環保、心靈成長或疫情後的社會變化，使內容更有共鳴。每次回應至多使用一個熱門話題即可。
...
@cache
def get_fortune_teller_agent() -> Agent:
    current_datetime = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    return Agent(
        name="神秘神棍",
        instructions=SYSTEM_PROMPT.format(datetime=current_datetime),
